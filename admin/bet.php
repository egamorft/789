...
$control = new EntityHttpControl($bets);
$control->id = "bet";
...
<body class="app">
    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <div class="row g-3 mb-4 align-items-center justify-content-between">
                    <div class="col-auto">
                        <h1 class="app-page-title mb-0">bet</h1>
                    </div>
                    <div class="col-auto">
                        <?php $data = $bet_meta;include __CMS1_INCLUDE__."page-utilities.php" ?>
                    </div>
                </div>
                        ...
                        <div class="app-card app-card-orders-table shadow-sm mb-5">
                            <div class="app-card-body">
                                <div class="table-responsive">
                                    <?php $meta = $bet_meta;$data = $control->data;$status_meta = ["block"=>"danger","active"=>"success"];include __CMS1_INCLUDE__."table.php" ?>
                                </div>
                            </div>
                        </div>
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <h1 class="app-page-title">bet</h1>
                <hr class="mb-4">
                <div class="row g-4 settings-section">
                    <div class="col-12">
                        <div class="app-card app-card-settings shadow-sm p-4">
                            <div class="app-card-body">
                                <?php $mode = $control->method;$meta = $bet_meta;$data = $control->data;$require = []; include __CMS1_INCLUDE__."form.php" ?>
                            </div>
                        </div>
                    </div>
                </div>
